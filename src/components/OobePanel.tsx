...
const OobePanel = styled((props: PopoverProps & OobePanelProps) => {
  ...
  useEffect(() => {
    setMicrophoneId(microphoneId ?? microphones.at(0)?.deviceId ?? '')
    setCameraId(cameraId ?? cameras.at(0)?.deviceId ?? '')
  }, [microphones, cameras])
